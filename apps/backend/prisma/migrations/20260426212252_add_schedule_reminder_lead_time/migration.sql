...
INSERT INTO "new_Settings" ("ENABLE_WHATSAPP_BOT_ASSIGNMENT_REMINDER", "ENABLE_WHATSAPP_BOT_BIRTHDAY_REMINDER", "ENABLE_WHATSAPP_BOT_DUTY_REPORT", "ENABLE_WHATSAPP_BOT_FUND_REPORT", "ENABLE_WHATSAPP_BOT_SUBJECT_SCHEDULE_REMINDER", "announcementGroupJid", "assignmentReminderTime", "birthdayMessageTemplate", "birthdayReminderTime", "createdAt", "dutyPersonalizedMessage", "dutyReminderTime", "fundReportDay", "fundReportTime", "id", "scheduleReminderLeadDays", "scheduleReminderTime", "timezone", "updatedAt") SELECT "ENABLE_WHATSAPP_BOT_ASSIGNMENT_REMINDER", "ENABLE_WHATSAPP_BOT_BIRTHDAY_REMINDER", "ENABLE_WHATSAPP_BOT_DUTY_REPORT", "ENABLE_WHATSAPP_BOT_FUND_REPORT", "ENABLE_WHATSAPP_BOT_SUBJECT_SCHEDULE_REMINDER", "announcementGroupJid", "assignmentReminderTime", "birthdayMessageTemplate", "birthdayReminderTime", "createdAt", "dutyPersonalizedMessage", "dutyReminderTime", "fundReportDay", "fundReportTime", "id", "scheduleReminderLeadDays", "scheduleReminderTime", "timezone", "updatedAt" FROM "Settings";
DROP TABLE "Settings";
