...
CREATE TABLE "new_Settings" (
    ...
    "dutyReminderLeadTime" TEXT NOT NULL DEFAULT '07:00',
    "scheduleReminderTime" TEXT NOT NULL DEFAULT '07:00',
    "scheduleReminderLeadTime" TEXT NOT NULL DEFAULT '20:00',
    "assignmentReminderTime" TEXT NOT NULL DEFAULT '18:00',
    "assignmentReminderLeadTime" TEXT NOT NULL DEFAULT '18:00',
    "birthdayReminderTime" TEXT NOT NULL DEFAULT '09:00',
    "dutyReminderLeadDays" INTEGER NOT NULL DEFAULT 0,
    "scheduleReminderLeadDays" INTEGER NOT NULL DEFAULT 0,
    "assignmentReminderLeadDays" INTEGER NOT NULL DEFAULT 0,
...
INSERT INTO "new_Settings" ("ENABLE_WHATSAPP_BOT_ASSIGNMENT_REMINDER", "ENABLE_WHATSAPP_BOT_BIRTHDAY_REMINDER", "ENABLE_WHATSAPP_BOT_DUTY_REPORT", "ENABLE_WHATSAPP_BOT_FUND_REPORT", "ENABLE_WHATSAPP_BOT_SUBJECT_SCHEDULE_REMINDER", "announcementGroupJid", "assignmentReminderTime", "birthdayMessageTemplate", "birthdayReminderTime", "createdAt", "dutyPersonalizedMessage", "dutyReminderTime", "fundReportDay", "fundReportTime", "id", "scheduleReminderLeadDays", "scheduleReminderLeadTime", "scheduleReminderTime", "timezone", "updatedAt") SELECT "ENABLE_WHATSAPP_BOT_ASSIGNMENT_REMINDER", "ENABLE_WHATSAPP_BOT_BIRTHDAY_REMINDER", "ENABLE_WHATSAPP_BOT_DUTY_REPORT", "ENABLE_WHATSAPP_BOT_FUND_REPORT", "ENABLE_WHATSAPP_BOT_SUBJECT_SCHEDULE_REMINDER", "announcementGroupJid", "assignmentReminderTime", "birthdayMessageTemplate", "birthdayReminderTime", "createdAt", "dutyPersonalizedMessage", "dutyReminderTime", "fundReportDay", "fundReportTime", "id", "scheduleReminderLeadDays", "scheduleReminderLeadTime", "scheduleReminderTime", "timezone", "updatedAt" FROM "Settings";
DROP TABLE "Settings";
